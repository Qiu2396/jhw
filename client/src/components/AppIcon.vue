<script setup>
/**
 * 全局线性图标（iconfont 风格：24 网格 / 2px 圆角描边）
 * 用法：<AppIcon name="play" :size="16" />，颜色跟随 currentColor
 */
...
const ICONS = {
  ...
  'star-full': '<polygon points="12 2 15.09 8.26 22 9.27 17 14.14 18.18 21.02 12 17.77 5.82 21.02 7 14.14 2 9.27 8.91 8.26 12 2"/>',
  ...
  monitor: '<rect x="2" y="3" width="20" height="14" rx="2"/><path d="M10 7.75a.75.75 0 0 1 1.14-.64l3.66 2.25a.75.75 0 0 1 0 1.28l-3.66 2.25a.75.75 0 0 1-1.14-.64z"/><path d="M12 17v4"/><path d="M8 21h8"/>',
  /* ---- 小工具 ---- */
